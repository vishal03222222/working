            ...
            <div className="w-full h-auto flex items-center justify-center flex-col lg:py-16 md:py-14 sm:py-12 py-10 lg:px-24 md:px-16 sm:px-6 px-4">
                ...
                md:flex-wrap sm:flex-wrap flex-wrap">
                    {exerciseData.map((data) => (
                        <div key={data.id}
                            className="lg:w-[24%] md:w-[48%] sm:w-[48%] w-full h-auto rounded-lg overflow-hidden hover: shadow ☐ hover:shadow-indigo-900/40 ease-out duration-700
                         cursor-pointer">
                            ...
                            <div className='w-full h-auto py-4 px-3'>
                                ...
                                <div className='w-full h-auto flex items-center gap-x-2'>
                                    <p className='text-s text-gray-300 '> {data.duration}</p>
                                    <span className='w-1 h-1 rounded-full bg-gray-600' />
                                    <p className='text-s text-gray-300 '> {data.sets}</p>
                                    <span className='w-1 h-1 rounded-full bg-gray-600' />
                                    <p className='text-s text-gray-300 '> {data.calories}</p>
