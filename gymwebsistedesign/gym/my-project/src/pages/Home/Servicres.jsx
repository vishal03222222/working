        ...
        md:py-14 sm:py-12 py-10 lg:px-24 md:px-16 sm:px-6 px-4">
            ...
            <div className="w-full h-auto flex items-center justify-center gap-x-4 gap-y-5 flex-wrap mb-10">
                {serviceData.map((data)=>(
                    ...
                    <div
                    key={data.id}
                    className=" lg:w-[24%] md:w-[48%] sm:w-[48%] w-full lg:h-[50vh] md:h-[53vh] sm:h-[58vh h-[60vh] rounded-x1 bg-black relative overflow-hidden cursor-pointer
                    z-10 hover:-translater-y-2 ease-out duration-500
                     "style={{
                        ...
                        <div className="w-full h-full flex items-center justify-center flex-col text-wite p-4 z-50">
                            <div className="w-14 h-14 rounded-full bg-indigo-600/20 border-4 border-indigo-600/80 flex items-center justify-center md-5">
                            <Dumbbell className="w-6 h-6 text-wite"/>
