...
const RoomDetails = () => {
  ...
  // If room is not found or data is still loading
  if (!room) {
    return <div>Loading...</div>; // Display a loading state or a 404 message
  }
  ...
  return (
    <section>
      ...
      >
        <div className="relative w-full h-full bg-black/70"></div>
        {/* title */}
        <h1 className="text-6xl text-white z-20 font-primary text-center">
          {name} Details
        </h1>
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row h-full py-2">
          ...
          <div className="w-full lg:w-[40%] bg-blue-300">
            <div className="py-8 px-6 bg-accent/20 mb-12">
              <div className="flex flex-col space-y-4 mb-4">
                <h3>Your reservation</h3>
                <div className="h-[60px]">
