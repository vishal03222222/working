  ...
  return (
    ...
    <hr />
    {
        songsData.map((items,index)=>(
            <div onClick={()=>playwidthid(items.id)} key={index} className='grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] ursor-pointer'>
